...
export const WhatsAppButton = () => {
  ...
  const whatsappUrl = `https://wa.me/${phoneNumber}?text=Hello%20Vyrax,%20I'm%20interested%20in%20your%20services.`;
  ...
  return (
    <motion.a
      ...
      className="fixed bottom-6 right-6 z-50 bg-white rounded-full p-3 shadow-lg"
